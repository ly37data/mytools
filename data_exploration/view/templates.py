# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 22:13:00 2019
...
from .formatters import fmt_percent, fmt_bytesize, fmt_numeric, fmt

# Initializing Jinja
package_loader = PackageLoader("mytools", "data_exploration/view/templates")
