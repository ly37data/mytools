...
# Load in a list of primitives registered by other libraries into feature_extraction
# Example entry_points definition for a library using this entry point:
#    entry_points={
#        "feature_extraction_primitives": [
#            other_library = other_library:LIST_OF_PRIMITIVES
#        ]
#    }
for entry_point in pkg_resources.iter_entry_points('feature_extraction_primitives'):
    try:
