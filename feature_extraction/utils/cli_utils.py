...
def show_info():
    subprocess.run(["feature_extraction", "info"])


def print_info():
    print("feature_extraction version: %s" % feature_extraction.__version__)
    print("feature_extraction installation directory: %s" % get_feature_extraction_root())
    print_sys_info()
    print_deps(deps)
...
def get_feature_extraction_root():
    return os.path.dirname(feature_extraction.__file__)
